...
def search_generals():
    ...
    if (search_select == '1'):
        ...
        select_ability(all_info)

    else:
        print("잘못된 입력입니다..")

def recruit_generals():
    global my_gold
...
def start_war():
    ...
    print("적군 출현....")
    enemy = []
    enemy_num = random.randint(len(my_choice), int(len(my_choice) * 1.6) )
